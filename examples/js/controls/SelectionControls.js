/**
 * Altered OrbitControls.js for selection handling
 * 
...
( function () {
	...
	function OrbitConstraint ( object ) {
		...
		this.pan = function ( deltaX, deltaY, screenWidth, screenHeight ) {
			...
			if ( scope.object instanceof THREE.PerspectiveCamera ) {
				...
				console.warn( 'WARNING: SelectionControls.js encountered an unknown camera type - pan disabled.' );
		...
		this.dollyIn = function ( dollyScale ) {
			...
			if ( scope.object instanceof THREE.PerspectiveCamera ) {
				...
				console.warn( 'WARNING: SelectionControls.js encountered an unknown camera type - dolly/zoom disabled.' );
	...
	THREE.SelectionControls = function ( object, domElement ) {
		...
		this.getAzimuthalAngle = function () {
			...
			return constraint.getAzimuthalAngle();
                ...
                this.setMaxPolarAngle = function(angle){
                    constraint.maxPolarAngle = angle;
                }
...
//					scope.update();
	...
	Object.defineProperties( THREE.SelectionControls.prototype, {
